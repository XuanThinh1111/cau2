                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="breadcrumb text-center">
                            <div class="section-headline white-headline"><br><br><br><br>
                                <h2 style="color:chartreuse;">Reviews</h2>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="single-testi">
                                <div class="testi-text">
                                    ...
                                    <div class="testi-img ">
                                        <img src="View/img/review/5.jpg" alt="">
                                        <div class="guest-details">
                                            <h4>Farmila</h4>
                                            <span class="guest-rev">Clients - <a href="#">General customer</a></span>
                                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="single-testi">
                                <div class="testi-text">
                                    ...
                                    <div class="testi-img ">
                                        <img src="View/img/review/6.jpg" alt="">
                                        <div class="guest-details">
                                            <h4>Timeo Poll</h4>
                                            <span class="guest-rev">Clients - <a href="#">General customer</a></span>
                                        </div>
