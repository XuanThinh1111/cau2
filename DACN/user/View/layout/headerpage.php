...
<meta charset="utf-8"><br><br><br>
		<title style="color: coral;"> BookStoreSTU </title>
                       ...
                       <div class="col-md-6 col-sm-6">
                           <div class="topbar-left">
                                <ul>
                                    ...
                                    <li><a href="#"><i class="fa fa-phone"></i> + 0377648490 &emsp;&ensp;</li>
                                    <br><h5 style="color: darkturquoise;">Chào mừng bạn đến với cửa hàng của chúng tôi</h5>
                                </ul>
							</div>
                        </div>
                        <div class=" col-md-6 col-sm-6">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbar-example">
                                            <div class="main-menu">
                                                <ul class="nav navbar-nav navbar-right">
                                                    ...
                                                    <li><a href="index.php?controller=baiviet">Bài vết, tin tức</a></li>
                                                    <!--<li><a href="investment.html">Investment</a></li>-->
                                                    <li><a class="pages" href="index.php?controller=tongsanpham">Sản phẩm</a>
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li><a href="index.php?controller=tieuthuyet">Tiểu Thuyết</a></li>
